...
if (isset($_SESSION['mot_de_passe']) AND $_SESSION['mot_de_passe'] == $_SESSION['pass'])
{
	...
	<form action="temps.php" method="post">
		...
		<?php
		//MONTH
		echo '<tr><td><select id="w_input_titrepartie" name="affmonth" />';
		$i=1;
		while ($i < 13)
		{
			{
		...
		//YEAR
		echo '<td><select id="w_input_titrepartie" name="affyear">';
		...
		//MATRICULE
		echo '<input type="hidden" name="affcoll" value='.$_SESSION['ID'].' /></td>';
		echo '<td align="right">&nbsp;<input type="submit" id="buttonval" value="Mettre a jour"></td>';
		?>
			<td align="right">&nbsp;
				<a href="temps-pdf.php?month=<?php echo $month; ?>&amp;year=<?php echo $year; ?>&amp;matricule=<?php echo $matricule; ?>" target="_blank"><img src="images/RoB_PDFdeact.png" title="<?php echo 'Extraire '.$month.'.'.$year.' sous PDF'; ?>" onmouseover="this.src='images/RoB_PDFact.png'" onmouseout="this.src='images/RoB_PDFdeact.png'" /></a>
			</td></tr>
		</table>
	</form>
