							...
							if (isset($_POST['IDmodif']))
							{
								...
								if ($checkrep != 0)
								{
									...
									while ($cur_nom = $reponse->fetch())
									{
										...
										echo '<h2>Informations g&eacute;n&eacute;rale</h2>';
										echo '<p>Nom :</p><input class="form-control form-control-small" type="text" name="nom" value="'.$cur_nom[1].'" />';
										echo '<p>Pr&eacute;nom :</p><input class="form-control form-control-small" type="text" name="prenom" value="'.$cur_nom[2].'" />';
										echo '<p>Trigramme :</p><input class="form-control form-control-small" type="text" size="5" name="trig" value="'.$cur_nom[3].'" />';
										echo '</fieldset>';
										echo '<h2>Param&egrave;tres</h2>';
										echo '<p>Effectif de type :<select class="form-control form-control-small" name="extstd">';
											...
											echo '</select></p>';
										echo '<p>Responsable hi&eacute;rarchique :<select class="form-control form-control-small" name="resp">';
											...
											echo '</select></p>';
										echo '<p>Affect&eacute; au p&ocirc;le :<select class="form-control form-control-small" name="pole">';
											...
											$reponse2->closeCursor();
											echo '</select></p>';
										echo '<p>Acc&egrave;s aux menus :<select class="form-control form-control-small" name="user_lev">';
											...
											$reponse2->closeCursor();
											echo '</select></p>';
										echo '<p>Droits sur la timesheet :<select class="form-control form-control-small" name="tms_lev">';
											...
											$reponse2->closeCursor();
											echo '</select></p>';
										echo '<p>Droits sur les frais :<select class="form-control form-control-small" name="exp_lev">';
											...
											$reponse2->closeCursor();
											echo '</select></p>';
										echo '<p>Droits sur les journaux : <select class="form-control form-control-small" name="jrl_lev">';
											...
											echo '</select></p>';
										echo '<fieldset id="infos-complementaires">';
										echo '<h2>Coordonn&eacute;es</h2>';
										echo '<p>T&eacute;l&eacute;phone :</p><input class="form-control form-control-small" type="text" size="20" name="tel" value="'.$cur_nom[10].'" />';
										echo '<p>Mobile :</p><input class="form-control form-control-small" type="text" size="20" name="mobile" value="'.$cur_nom[11].'" />';
										echo '<p>Email :</p><input class="form-control form-control-small" type="text" size="50" name="mail" value="'.$cur_nom[12].'" />';
										echo '<p>Adresse :</p><input class="form-control form-control-small" type="text" size="50" name="adresse" value="'.$cur_nom[16].'" />';
										echo '<p>CP :</p><input class="form-control form-control-small" type="text" size="7" name="cp" value="'.$cur_nom[15].'" />';
										echo '<p>Ville :</p><input class="form-control form-control-small" type="text" size="20" name="ville" value="'.$cur_nom[14].'" />';
										echo '<p>Pays :</p><input class="form-control form-control-small" type="text" size="15" name="pays" value="'.$cur_nom[13].'" />';
										echo '</fieldset>';
										echo '<section id="param-conges">';
										echo '<h2>Solde des cong&eacute;s, RTT et r&eacute;cup&eacute;rations</h2>';
											...
											{
												$dchk = $check->fetch();
												echo '<p>R&eacute;cup :'.number_format($dchk[0],2,",","").'<input type="hidden" name="absrecup" value="0" /></p>';
											} else {
												echo '<p>R&eacute;cup :'.number_format(0,2,",","").'<input type="hidden" name="absrecup" value="0" /></p>';
											}
											$check->closeCursor();
										echo '<p>Cong&eacute;s pay&eacute;s :<input class="form-control form-control-small" type="text" size="5" name="abscp" value="'.$cur_nom[18].'" /></p>';
										echo '<p>RTT :<input class="form-control form-control-small" type="text" size="15" name="absrtt" value="'.$cur_nom[19].'" /></p>';
										echo '</section>';
									}
