...
if (isset($_SESSION['mot_de_passe']) AND $_SESSION['mot_de_passe'] == $_SESSION['pass'])
{
	...
	<div id="navigationMap">
		...
		<li><a class="typ" href="#"><span>Cat&eacute;gorie de fournisseur</span></a></li></ul>
	</div>
	<div id="clearl"></div>
	<div id="haut">Cat&eacute;gorie de fournisseur</div>
	...
	<div id="sstitre">Ajouter une nouvelle cat&eacute;gorie de fournisseur</div>
	<table id="tablerestit" class="table table-striped temp-table">
		<tr>
			<td id="t-containertit">Code</td>
